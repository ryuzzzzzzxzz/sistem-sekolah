            ...
            <div class="bg-white shadow rounded-lg p-4" >
                <div action="" class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-2 border rounded-lg" type="text"  id="name" placeholder="Masukkan Nama" Name="Nama" readonly>
                    </div>
                    <div class="space-y-2">
                        <label for="class" class="block text-sm font-medium text-gray-700">Kelas</label>
                        <input class="w-full px-4 py-2 border rounded-lg" type="text" name="class" id="class" placeholder="Masukkan Kelas" readonly>
                    </div>
                    <div class="space-y-2">
                        <label for="nis" class="block text-sm font-medium text-gray-700">NIS</label>
                        <input class="w-full px-4 py-2 border rounded-lg" type="text" name="nis" id="nis" placeholder="Masukkan NIS" readonly>
                    </div>
                    <div class="space-y-2">
                        <label for="phone_number" class="block text-sm font-medium text-gray-700">No Telepon</label>
                        <input class="w-full px-4 py-2 border rounded-lg" type="text" name="phone_number" id="phone_number" placeholder="Masukkan nomor telepon" readonly>
                    </div>
